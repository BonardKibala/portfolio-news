      ...
      <SkillsContainer>
        ...
        <Content>
          <SkillsContent>
            ...
            <Skill>
              <SkillImage color="#0081f6">
                <FaCss3 />
              </SkillImage>
              <SkillName>Css3</SkillName>
            </Skill>
            <Skill>
              <SkillImage color="#bd3482">
                <FaSass />
              </SkillImage>
              <SkillName>Sass</SkillName>
            </Skill>
            <Skill>
              <SkillImage color="#eac950">
                <FaJs />
              </SkillImage>
              <SkillName>JavaScript</SkillName>
            </Skill>
            <Skill>
              <SkillImage color="#0da7c0">
                <FaReact />
              </SkillImage>
              <SkillName>ReactJS</SkillName>
            </Skill>
            <Skill>
              <SkillImage color="white">
                <FaGithub />
              </SkillImage>
            ...
            <Skill>
              <SkillImage color="gray">
                <FaGit />
              </SkillImage>
              <SkillName>Git</SkillName>
            </Skill>
            <Skill>
              <SkillImage color="green">
                <DiMongodb />
              </SkillImage>
              <SkillName>Mongodb</SkillName>
            </Skill>
            <Skill>
              <SkillImage color="#005a88">
                <SiMysql />
              </SkillImage>
              <SkillName></SkillName>
            </Skill>
            <Skill>
              <SkillImage color="#c8606b">
                <SiMicrosoftsqlserver />
              </SkillImage>
